...
@EnableTransactionManagement // Bật quả lý transaction cho web mvc
public class AppConfig {
    ...
    public Properties addionalProperties() {
         ...
         * ==> Dùng khi chạy ứng dụng lần đầu tiên
         *
         ...
         *      + Entity: clm1, clm2, clm3 - Table: clm1, clm2 --> sinh thêm clm3 trong table
         *      + Entity: clm1, clm2 - Table: clm1,clm2, clm3 --> không sửa bảng , giữ nguyên 3 bảng hiện tại
         *      + Entity: clm1, clm2 - Table: clm1, clm2 --> ví dụ sửa clm1 trong entity thang clm3 --> table: clum1, clm2, clm3
         * ==> thích hợp trong việc đang chạy dự án , phát triển dự án
         *
